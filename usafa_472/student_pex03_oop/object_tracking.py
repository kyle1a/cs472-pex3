...
def load_visdrone_network():
    ...
    in_weights = '/home/usafa/usafa_472/student_pex03_oop/yolo_visdrone/yolov4-tiny-custom_last.weights'
    in_config = '/home/usafa/usafa_472/student_pex03_oop/yolo_visdrone/yolov4-tiny-custom.cfg'
    name_file = '/home/usafa/usafa_472/student_pex03_oop/yolo_visdrone/custom.names'
...
def confirm_obj_in_bbox(frame, bbox, frame_write=None, show_img=False, in_debug=False):
    try:
        ...
        if show_img:
            ...
            # cv2.putText(blank_image, f'confidence: {confidence}', (75, 75), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 255, 255), 2)
            # cv2.putText(blank_image, f'in_debug: {in_debug}', (75, 200), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 255, 255), 2)
            # cv2.imshow("what the computer sees", blank_image)
...
def track_with_confirm(img, img_write=None, show_img=False, debug_mode=False):
    ...
    if total_track_misses >= TRACKER_MISSES_MAX:
        ...
        cv2.putText(frm_display, "Tracking...", (100, 80), cv2.FONT_HERSHEY_SIMPLEX, 0.75,
                    (0, 0, 255), 2)
        # cv2.putText(frm_display, f"track misses: {total_track_misses}", (100, 80), cv2.FONT_HERSHEY_SIMPLEX, 0.75,
        #             (0, 0, 255), 2)
